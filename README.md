...
**Pollito** is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] Replace all icon drawables and other static image assets with [vextor drawables](http://guides.codepath.org/android/Drawables#vector-drawables) where appropriate.
...
Sometimes it's not about how hard the task is to do or complete it's how much time you are allowed; however, the practice of Engineering is all about working around the constraints and time is definitely a big constraint in Software Development.
